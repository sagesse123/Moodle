...
$string['completionengagementtalks_desc'] = 'L\'étudiant doit prendre la parole {$a} fois pour achever l\'activité.';
...
$string['enablingbigbluebuttondpainfo'] = 'Afin de remplir vos obligations en terme de protection des données, avant d\'activer ce plugin, vous devez confirmer que vous avez lu et accepté l\'<a href="{$a}" target="_blank">accord sur le traitement des données de Blindside Networks Inc.</a> Veuillez consulter vos spécialistes sur la protection des données pour des conseils.';
