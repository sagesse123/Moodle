...
$string['name'] = 'Nom';
$string['name_help'] = 'La nom d\'une visite guidée doit être écrite en texte pur, avec au besoin des balises multilingues lorsque le filtre multilingue est utilisé.
...
$string['tour1_content_customisation'] = 'Pour personnaliser l\'apparence de votre site et de sa page d\'accueil, utilisez le menu des réglages au coin de cette entête. Activez le mode édition maintenant.';
